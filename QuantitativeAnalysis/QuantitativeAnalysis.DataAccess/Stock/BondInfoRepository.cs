...
{
    public class BondInfoRepository
    {
        ...
        public void UpdateConvertibleBondInfoToNow()
        {
            var bondInfos = GetConvertibleBondInfoFromSql();

        }

        public List<ConvertibleBondDailyInfo> GetConvertibleBondInfoFromSql()
        {
            List<ConvertibleBondDailyInfo> infos = new List<ConvertibleBondDailyInfo>();
            return infos;
        }
